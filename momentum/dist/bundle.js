...
const weatherService = axios__WEBPACK_IMPORTED_MODULE_1__["default"].create({
...
const fillElementsOnWeatherBlock = async (city = 'Minsk') => {
  if (city === '') {
    notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_0__.Notify.failure('Empty input', {
      position: 'center-top',
      timeout: 2000,
    });
    return;
  ...
  try {
    ...
    notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_0__.Notify.failure('Such city doesn`t exist, try another one', {
      position: 'center-top',
      timeout: 2000,
    });
  }
