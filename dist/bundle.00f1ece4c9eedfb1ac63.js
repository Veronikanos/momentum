...
/* harmony import */ var _utils_quotesUA__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/quotesUA */ "./src/utils/quotesUA.json");
...
const putQuoteToMarkup = randomQuoteNumber => {
  ...
  const allQuotes = language === 'en' ? _utils_quotesEN__WEBPACK_IMPORTED_MODULE_0__ : _utils_quotesUA__WEBPACK_IMPORTED_MODULE_1__;
...
const translateText = async () => {
  ...
  // ) {
  await (0,_weather__WEBPACK_IMPORTED_MODULE_3__.fillElementsOnWeatherBlock)(localStorage.getItem('city'));
  // }
};
...
module.exports = JSON.parse('[{"text":"Success is one percent inspiration, ninety-nine percent perspiration.","author":"Thomas Edison"},{"text":"Better to have lost and loved than never to have loved at all.","author":"Ernest Hemingway"},{"text":"You can never be overdressed or overeducated.","author":"Oscar Wilde"},{"text":"Fall seven times and stand up eight","author":"Japanese Proverb"},{"text":"Success is not the key to happiness. Happiness is the key to success.","author":"Herman Cain"},{"text":"Learning is a treasure that will follow its owner everywhere.","author":"Chinese Proverb"},{"text":"Success is the child of audacity.","author":"Benjamin Disraeli"},{"text":"Never make fun of someone who speaks broken English. It means they know another language.","author":"H. Jackson Brown, Jr."},{"text":"Only two things are infinite — the universe and human stupidity, and I’m not sure about the former.","author":"Albert Einstein"},{"text":"Fake It Until You Make It! Act As If You Had All The Confidence You Require Until It Becomes Your Reality.","author":"Brian Tracy"},{"text":"The more you say, the less people remember.","author":"François Fénelon"},{"text":"Even if you have only a puck goat to sell, be in the middle of the fair with it.","author":"Irish proverb"}]');

/***/ }),

/***/ "./src/utils/quotesUA.json":
/*!*********************************!*\
  !*** ./src/utils/quotesUA.json ***!
  \*********************************/
/***/ ((module) => {

module.exports = JSON.parse('[{"text":"Успіх — це один відсоток натхнення і дев’яносто дев’ять відсотків поту","author":"Томас Едісон"},{"text":"Краще любити і втратити, ніж не любити зовсім","author":"Ернест Хемінгуей"},{"text":"Не можна бути занадто добре одягненим або занадто добре освіченим.","author":"Оскар Уайльд"},{"text":"Упади сім разів, піднімись вісім.","author":"Японське прислів\'я"},{"text":"Успіх - не ключ до щастя. Це щастя - ключ до успіху.","author":"Герман Кейн"},{"text":"Знання - це скарб, який завжди іде за тим, хто ним володіє.","author":"Китайське прислів\'я"},{"text":"Успіх - дитина сміливості.","author":"Бенджамін Дізраелі"},{"text":"Ніколи не смійтеся з людини, яка говорить ламаною англійською. Це означає, що вона знає іншу мову.","author":"Х. Джексон Браун молодший"},{"text":"Дві речі безкінечні - Всесвіт та людська дурість, але щодо Всесвіту я не впевнений.","author":"Альберт Ейнштейн"},{"text":"Уявляйте, доки не вдасться! Дійте так, ніби у вас є вся необхідну впевненість, доки вона не стане вашою реальністю.","author":"Браян Трейсі"},{"text":"Чим більше ви скажете, тим менше люди запам\'ятають.","author":"Франсуа Фенелон"},{"text":"Навіть якщо у вас на продаж одна коза, будьте з нею в центрі ярмарку.","author":"Ірландське прислів\'я"}]');
